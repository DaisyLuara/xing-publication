...
class DemandModifyController extends Controller
{
     ...
     * @throws \Exception
     */
    public function index(Request $request, DemandModify $demandModify)
    {
    ...
    public function show(DemandModify $demandModify)
    {
     ...
     * @return \Dingo\Api\Http\Response
     */
    public function store(DemandModifyRequest $request, DemandModify $demandModify)
    {
        /** @var User $user */
        $user = Auth::user();
     ...
     * @return \Dingo\Api\Http\Response
     */
    public function update(DemandModifyRequest $request, DemandModify $demandModify)
    {
        /** @var User $user */
        $user = Auth::user();
     ...
     * @return \Dingo\Api\Http\Response
     */
    public function reviewDemandModify(Request $request, DemandModify $demandModify)
    {
        /** @var User $user */
        $user = Auth::user();
     ...
     * @return \Dingo\Api\Http\Response
     */
    public function feedbackDemandModify(Request $request, DemandModify $demandModify)
    {
        /** @var User $user */
        $user = Auth::user();
