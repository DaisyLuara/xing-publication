...
$api->version('v1', [
    ...
    $api->group([
        ...
        $api->group(['middleware' => "api.auth", 'model' => 'App\Models\User'], function ($api) {
            ...
            //合同管理
            $api->get('contract/export', ['middleware' => ['permission:contract.list.read'], 'uses' => 'ContractController@export']); //下载
            ...
            // 审批历史
            $api->get('contract_history/export', ['middleware' => ['permission:contract.history.read'], 'uses' => 'ContractHistoryController@export']);
            ...
            //成本管理
            $api->get('contract_cost/export', ['middleware' => ['permission:contract.cost.read'], 'uses' => 'ContractCostController@export']); //下载
