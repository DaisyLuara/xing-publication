...
$api->version('v1', [
    ...
    $api->group([
        ...
        $api->group(['middleware' => "api.auth", 'model' => 'App\Models\User'], function ($api) {
            ...
            $api->post('companies', ['middleware' => ['role:user|bd-manager'], 'uses' => 'AdminCompaniesController@store']);
            $api->patch('companies/{company}', ['middleware' => ['role:user|bd-manager'], 'uses' => 'AdminCompaniesController@update']);
