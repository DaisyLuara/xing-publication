...
$api->version('v1', [
    ...
    $api->group([
        ...
        $api->group(['middleware' => "api.auth", 'model' => 'App\Models\User'], function ($api) {
            ...
            $api->get('payment/export', ['middleware' => ['permission:payment.list.read'], 'uses' => 'PaymentController@export']);
            ...
            $api->get('payment_payee/export', ['middleware' => ['permission:payment.payee.read'], 'uses' => 'PaymentPayeeController@export']);
            ...
            $api->get('payment_history/export', ['middleware' => ['permission:payment.history.read'], 'uses' => 'PaymentHistoryController@export']);
