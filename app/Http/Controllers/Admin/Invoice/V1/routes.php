...
$api->version('v1', [
    ...
    $api->group([
        ...
        $api->group(['middleware' => "api.auth", 'model' => 'App\Models\User'], function ($api) {
            ...
            $api->get('invoice/export', ['middleware' => ['permission:invoice.list.read'], 'uses' => 'InvoiceController@export']);//下载
            ...
            //开票公司
            $api->get('invoice_company/export', ['middleware' => ['permission:invoice.invoiceCompany.read'], 'uses' => 'InvoiceCompanyController@export']);//下载
            ...
            //财务收款
            $api->get('invoice_receipt/export', ['middleware' => ['permission:invoice.receipt.read'], 'uses' => 'InvoiceReceiptController@export']);//下载
