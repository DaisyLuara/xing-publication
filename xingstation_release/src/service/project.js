...
export default {
  ...
  getProjectListDetails(context,args) {
    return new Promise(function(resolve, reject){
      context.$http.get(HOST + PROJECTLIST_API, {params: args}).then(response => {
        resolve(response.data)
      }).catch(error => {
        reject(error)
      })
  ...
  savePorjectLaunch(context, args) {
    return new Promise(function(resolve, reject){
      context.$http.post(HOST + PROJECT_API, args).then(response => {
        resolve(response.data)
      }).catch(error => {
        reject(error)
      })
  ...
  modifyProjectLaunch(context, args){
    return new Promise(function(resolve, reject){
      context.$http.patch(HOST + MODIFY_PROJECT_API, args).then(response => {
        resolve(response.data)
      }).catch(error => {
        reject(error)
      })
