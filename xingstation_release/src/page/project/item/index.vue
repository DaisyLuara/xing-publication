    ...
    >
      <div class="item-content-wrap">
        ...
        >
            ...
            <template slot-scope="scope">
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                <el-form-item label="点位状态">
                  <span>{{ scope.row.point.visiable === 1 ? '运营中' : '下架' }}</span>
                </el-form-item>
          ...
          <el-table-column :show-overflow-tooltip="true" prop="name" label="节目名称" min-width="150">
            <template slot-scope="scope">{{ scope.row.project.name }}</template>
          </el-table-column>
          <el-table-column prop="icon" label="节目icon" min-width="100">
            <template slot-scope="scope">
