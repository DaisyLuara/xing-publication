            ...
            <template slot-scope="scope">
              <el-form label-position="left" inline class="demo-table-expand">
                ...
                <el-form-item label="优惠券描述">
                  <span>{{scope.row.coupon_desc}}</span> 
                </el-form-item>
                <el-form-item label="图片">
                  <a :href="scope.row.image" target="_blank" style="color: blue">查看</a> 
                </el-form-item>
      ...
      tableData: [
        {
          ...
          coupon_name: '龙虾刑警',
          coupon_desc:'',
          image: 'http://image.exe666.com/1007/image/1530696265.png',
          amount: 100,
          count: 100,
          stock: 90,
          people_max_get: 1,
