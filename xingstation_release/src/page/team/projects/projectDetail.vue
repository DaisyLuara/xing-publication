      ...
      <div 
        ...
        <el-card 
          ...
          <div 
            class="search-wrap">
            <h2 
              style="font-size:25px;font-weight:700">{{ content }}</h2>
          </div>
          <hr>
          <div 
            class="task-wrap">
            <div 
              ...
              <el-checkbox label="" />
              <span 
                style="font-size:22px;margin-left:6px">{{ content }}</span>
            </div>
            <div 
              class="des-wrap">
              <p 
            ...
            <ul 
              ...
              <li 
                v-for="(item,index) in infoIncluded" 
                v-if="item.type==='todos_check_items'"
                :key="index" 
              >
                <el-checkbox 
                  v-model="item.attributes.is_completed"
                  label="" 
                />
            ...
            <div 
              ...
              <span 
                style="font-size:18px;color:#999">添加检查项</span>
            </div>
          </div>  
        </el-card>
      </div>  
