          ...
          <el-table-column 
            ...
            <template 
              ...
              <el-button
                size="small" 
                type="warning"
                @click="editHandle(scope.row)">{{ ((role.name === 'project-manager' && (scope.row.status === '进行中' || scope.row.status === '测试已确认')) || role.name === 'legal-affairs-manager'  || role.name === 'bonus-manager' ) ? '修改': '查看'  }}</el-button>
              <el-button 
