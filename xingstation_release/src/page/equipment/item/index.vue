            ...
            <template 
              ...
              <el-form 
                ...
                <el-form-item 
                  label="上次互动">
                  <span 
                    style="color: rgb(93, 217, 49)">{{ scope.row.faceDate }}</span>
                </el-form-item>
                <el-form-item 
                  label="联网时间">
                  <span 
                    style="color: rgb(93, 217, 49)">{{ scope.row.networkDate }}</span>
                </el-form-item>
                <el-form-item 
                  label="屏幕状态">
                  <span 
                ...
                <el-form-item 
                  label="智能插排">
                  <span 
                    style="color: rgb(93, 217, 49)">{{ scope.row.device_id === '' ? '': '有' }}</span>
                </el-form-item>
                <el-form-item 
                  label="创建时间">
