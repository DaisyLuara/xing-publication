...
class UpdateContractTable extends Migration
{
    ...
    public function up()
    {
        Schema::table('contracts', function (Blueprint $table) {
            $table->smallInteger('kind')->after('product_status')->comment('合同种类 1:铺屏,2:销售,3:租赁,4:服务');
            $table->smallInteger('serve_target')->default(0)->after('kind')->comment('服务对象 1:商户,2:商场');
            $table->smallInteger('recharge')->default(0)->after('serve_target')->comment('预充值 0:否,1:是');
