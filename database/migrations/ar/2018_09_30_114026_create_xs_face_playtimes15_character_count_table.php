...
class CreateXsFacePlaytimes15CharacterCountTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('ar')->create('xs_face_playtimes15_character_count', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('oid');
    ...
    {
        Schema::connection('ar')->dropIfExists('xs_face_playtimes15_character_count');
    }
}
