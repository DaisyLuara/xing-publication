...
class CreateXsFacePlaytimes7PermeabilityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::connection('ar')->create('xs_face_playtimes7_permeability', function (Blueprint $table) {
            $table->increments('id');
            $table->integer('oid');
    ...
    {
        Schema::connection('ar')->dropIfExists('xs_face_playtimes7_permeability');
    }
}
